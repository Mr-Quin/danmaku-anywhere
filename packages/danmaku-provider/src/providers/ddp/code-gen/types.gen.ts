...
export type AnimeType = 'tvseries' | 'tvspecial' | 'ova' | 'movie' | 'musicvideo' | 'web' | 'other' | 'jpmovie' | 'jpdrama' | 'unknown' | 'tmdbtv' | 'tmdbmovie';
...
export type BangumiGetShinBangumiResponse = BangumiGetShinBangumiResponses[keyof BangumiGetShinBangumiResponses];
...
export type BangumiGetSeasonBangumiOfAnimeResponse = BangumiGetSeasonBangumiOfAnimeResponses[keyof BangumiGetSeasonBangumiOfAnimeResponses];
...
export type BangumiGetSeasonsResponse = BangumiGetSeasonsResponses[keyof BangumiGetSeasonsResponses];
...
export type BangumiGetQueueIntroResponse = BangumiGetQueueIntroResponses[keyof BangumiGetQueueIntroResponses];
...
export type BangumiGetQueueDetailsResponse = BangumiGetQueueDetailsResponses[keyof BangumiGetQueueDetailsResponses];
...
export type BangumiGetBangumiDetailsResponse = BangumiGetBangumiDetailsResponses[keyof BangumiGetBangumiDetailsResponses];

export type BangumiGetBangumiDetailsByBgmtvSubjectIdData = {
    body?: never;
    path: {
        /**
         * Bangumi.tv的subjectId
         */
...
export type BangumiGetBangumiDetailsByBgmtvSubjectIdResponses = {
    200: BangumiDetailsResponse;
};

export type BangumiGetBangumiDetailsByBgmtvSubjectIdResponse = BangumiGetBangumiDetailsByBgmtvSubjectIdResponses[keyof BangumiGetBangumiDetailsByBgmtvSubjectIdResponses];
...
export type CommentSendCommentResponse = CommentSendCommentResponses[keyof CommentSendCommentResponses];
...
export type FavoriteGetUserFavoriteResponse = FavoriteGetUserFavoriteResponses[keyof FavoriteGetUserFavoriteResponses];
...
export type FavoriteAddFavoriteResponse = FavoriteAddFavoriteResponses[keyof FavoriteAddFavoriteResponses];
...
export type FavoriteDeleteFavoriteResponse = FavoriteDeleteFavoriteResponses[keyof FavoriteDeleteFavoriteResponses];
...
export type HomepageGetBannerResponse = HomepageGetBannerResponses[keyof HomepageGetBannerResponses];
...
export type LoginRenewTokenResponse = LoginRenewTokenResponses[keyof LoginRenewTokenResponses];
...
export type MatchBatchMatchResponse = MatchBatchMatchResponses[keyof MatchBatchMatchResponses];
...
export type PlayHistoryGetUserPlayHistoryResponse = PlayHistoryGetUserPlayHistoryResponses[keyof PlayHistoryGetUserPlayHistoryResponses];
...
export type PlayHistoryAddPlayHistoryResponse = PlayHistoryAddPlayHistoryResponses[keyof PlayHistoryAddPlayHistoryResponses];
...
export type RegisterRegisterMainUserResponse = RegisterRegisterMainUserResponses[keyof RegisterRegisterMainUserResponses];
...
export type RegisterResetPasswordResponse = RegisterResetPasswordResponses[keyof RegisterResetPasswordResponses];
...
export type RegisterFindMyIdResponse = RegisterFindMyIdResponses[keyof RegisterFindMyIdResponses];
...
export type RelatedDeleteRelatedResponse = RelatedDeleteRelatedResponses[keyof RelatedDeleteRelatedResponses];
...
export type RelatedGetRelatedResponse = RelatedGetRelatedResponses[keyof RelatedGetRelatedResponses];
...
export type RelatedAddRelatedResponse = RelatedAddRelatedResponses[keyof RelatedAddRelatedResponses];
...
export type SearchSearchAnimeResponse = SearchSearchAnimeResponses[keyof SearchSearchAnimeResponses];
...
export type SearchSearchTmdbResponse = SearchSearchTmdbResponses[keyof SearchSearchTmdbResponses];
...
export type SearchSearchEpisodesResponse = SearchSearchEpisodesResponses[keyof SearchSearchEpisodesResponses];
...
export type SearchSearchAnimeByTagResponse = SearchSearchAnimeByTagResponses[keyof SearchSearchAnimeByTagResponses];
...
export type SearchGetSearchAdvConfigResponse = SearchGetSearchAdvConfigResponses[keyof SearchGetSearchAdvConfigResponses];
...
export type SearchSearchAdvancedResponse = SearchSearchAdvancedResponses[keyof SearchSearchAdvancedResponses];
...
export type UserUpdateUserEmailResponse = UserUpdateUserEmailResponses[keyof UserUpdateUserEmailResponses];
