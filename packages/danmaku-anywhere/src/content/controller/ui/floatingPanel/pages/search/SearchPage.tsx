...
import { useAutoMount } from '@/content/controller/ui/floatingPanel/pages/search/useAutoMount'
...
export const SearchPage = () => {
  ...
  const { autoMountEpisode } = useAutoMount()
  ...
  return (
    <TabLayout>
      ...
      {tab === 'parse' && (
        <ParseTabCore autoMount={true} onImportSuccess={autoMountEpisode} />
      )}
    </TabLayout>
  )
}
