...
import { useWindowActive } from '@/content/common/hooks/useWindowActive'
...
>(({ onOpen, isOpen }: FloatingButtonProps, ref) => {
  ...
  const isIn =
    !isPicking && !editModeActive && (showFab || isOpen || !!contextMenuAnchor)
